/*
  ...
  - Added the required column `prefernces` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "prefernces" JSONB NOT NULL,
